...
const words = ["private", "secure", "non-custodial", "transparent"];
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        >
          <span className="inline-flex items-center gap-3 text-sm font-mono text-white/60">
            ...
            Private DEX on Solana powered by Jupiter and Jito
          </span>
        </div>
        ...
        <div className="mb-12">
          ...
          >
            <span className="block">Swap with privacy,</span>
