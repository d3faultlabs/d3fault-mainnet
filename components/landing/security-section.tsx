...
const securityFeatures = [
  {
    ...
    description: "Wallet seeds encrypted locally with military-grade encryption. PBKDF2 with 100K iterations.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Lock,
    title: "Non-custodial Design",
    description: "You control your private keys. Seeds never leave your device. Zero server-side storage.",
    image: "/images/secure.jpg",
  },
  {
    icon: Eye,
    title: "URL Hash Secrets",
    description: "Claim link secrets in URL hash fragments. Never transmitted to server over HTTP.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "On-Chain Verification",
    description: "Commitment-nullifier scheme prevents double-spending. Transparent Solana program code.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["Non-custodial", "Open Source", "Auditable", "Zero Logs"];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] mb-12 transition-all duration-1000 ${
            ...
            <br />
            <span className="text-muted-foreground">always transparent.</span>
          </h2>
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Your keys are encrypted locally. No third-party analytics. Open-source Solana program for verification.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <span className="font-mono text-sm text-muted-foreground">Privacy foundation</span>
              <div className="mt-8">
