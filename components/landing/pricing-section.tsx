...
const plans = [
  {
    name: "Demo",
    description: "Test D3FAULT on Devnet safely",
    price: { monthly: 0, annual: 0 },
    features: [
      "Full swap functionality",
      "Private transfers via claim links",
  ...
  {
    name: "Mainnet Beta",
    description: "Full non-custodial privacy DEX",
    price: { monthly: null, annual: null },
    features: [
      "Live on Mainnet (pending deploy)",
      "Jupiter swap aggregation",
      "Jito MEV protection",
      "0.2% platform fee per swap",
      "Commitment-nullifier transfers",
  ...
  {
    name: "Custom",
    description: "Integration & advanced features",
    price: { monthly: null, annual: null },
    features: [
      "API access",
